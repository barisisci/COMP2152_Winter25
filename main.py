...
weaponName = str(weapons[weaponRoll])
...
elif weaponRoll <= 4 and weapons[weaponRoll] != "Fist":
    print("Your weapon is meh")
    print("Thank goodness you didn't roll the Fist")
elif weapons[weaponRoll] != "Fist" :
    print("Thank goodness you didn't roll the Fist")
else :
...
print("Your " + weaponName +  " (" + str(combatStrength) + ") ---> Monster (" + str(mHealthPoints) + ")")
